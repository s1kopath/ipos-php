                ...
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <span class="text-muted">*Make sure the Product Code Is Compatible (Ex: TT0001)</span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="10" step="10"class="form-control"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="">Minimul Stock</label><br>
                            <input type="number" min="1" step="1"
