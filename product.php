...
<!--
			    ...
			    <a href="category.php" type="button" class="btn btn-primary">Add Product Category</a>
			    <a href="satuan.php" type="button" class="btn btn-info">Add Product Unit</a>
                    ...
                    <table class="table table-striped" id="myProduct">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>Tk <?php echo number_format($row->purchase_price);?></td>
                                <td>Tk <?php echo number_format($row->sell_price); ?></td>
