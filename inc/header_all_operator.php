...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>I</b>EMS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Inventory|</b>EMS</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="order.php"><i class="fa fa-shopping-cart"></i> <span>Transation</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
