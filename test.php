<?php
   ...
   if($_SESSION['username']==""){
    ...
    if(isset($_POST['save_order'])){
      ...
      $arr_product_code = $_POST['username'];
      ...
      if($arr_product_code == ""){
        ...
        if($invoice_id!=null){
          for($i=0; $i<count($arr_product_id); $i++){
            ...
            values(:invid, :productid, :username, :productname, :qty, :productsatuan, :price, :total, :orderdate)");

            $insert->bindParam(':invid',  $invoice_id);
            $insert->bindParam(':productid',   $arr_product_id[$i]);
            $insert->bindParam(':username',   $arr_product_code[$i]);
        ...
        <div class="box box-success">
          <form action="" method="POST">
            ...
            <div class="box-body">
              <div class="col-md-offset-1 col-md-10">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-addon">
                      <span>Tk <?php echo $_SESSION['invoice_id']; ?></span>
                    </div>
            ...
            <div class="box-footer" align="center">
              <input type="submit" name="save_order" value="Save Transection" class="btn btn-success">
  ...
  //Date picker
    ...
    $(document).ready(function(){
      $(document).on('click','.btn_addOrder', function(){
        var html='';
        html+='<tr>';
        html+='<td><input type="hidden" class="form-control username" name="username[]" readonly></td>';
        html+='<td><select class="form-control productid" name="productid[]" style="width:200px;" required><option value="">--Select --</option><?php
        ...
        $('.productid').on('change', function(e){
          ...
          $.ajax({
            ...
            success:function(data){
              //console.log(data);
              tr.find(".username").val(data["product_code"]);
