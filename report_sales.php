        ...
        <div class="box box-success">
          <form action="" method="POST" autocomplete="off">
            <div class="box-header with-border">
                <h3 class="box-title">From : <?php echo $_POST['date_1']?>
                </h3>
                <h3 class="box-title">   To : <?php echo $_POST['date_2'] ?>
                </h3>
            </div>
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type="submit" name="date_filter" value="See" class="btn btn-success btn-sm">
                </div>
                <br>
              </div>
                  <?php
                ...
                <div class="col-md-offset-1 col-md-5 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">Tk <?php echo number_format($total,0) ; ?></span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                  ...
                  <table class="table table-striped" id="mySalesReport">
                      ...
                      <?php
                            ...
                            ?>
                                ...
                                <td>Tk <?php echo number_format($row->total); ?></td>
                                </tr>
                            <?php
                            }
                            ?>
